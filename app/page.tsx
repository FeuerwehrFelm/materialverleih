...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(244,255,0,0.22),_transparent_45%)] px-4 py-8 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <section className="overflow-hidden rounded-[32px] border border-[#f4ff00]/25 bg-[#081120]/90 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] sm:p-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Link href="/materialverleih" className="inline-flex items-center gap-2 rounded-full bg-[#f4ff00] px-4 py-3 font-semibold text-[#081120] transition hover:bg-[#fbff9a]">
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          <div className="rounded-[24px] border border-[#f4ff00]/20 bg-[#081120]/85 p-6">
